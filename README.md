...
- خدمة محلية Rust لتمرير طلب التفعيل بصورة خفيفة.
- Cloud API مكتوب بـ Python/Flask يولد المفاتيح بعد التحقق المركزي ويحفظ السجلات في PostgreSQL.
...
لا تحتوي نسخة العميل الجديدة خوارزمية توليد المفاتيح، ويمنع الخادم
التوليد عند ضبط الحالة على `0`.
